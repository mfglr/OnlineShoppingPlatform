...
{
    internal class RemoveItemHandler(ICartRepository cartRepository, IHttpContextAccessor httpContextAccessor) : IRequestHandler<RemoveCartItemDto>
    {
        private readonly ICartRepository _cartRepository = cartRepository;
        private readonly IHttpContextAccessor _httpContextAccessor = httpContextAccessor;

        public async Task Handle(RemoveCartItemDto request, CancellationToken cancellationToken)
        {
